...
export default function ProductsLandingPage() {
  return (
    <section className="products-landing-page-section">
      <div className="products-landing-page">
        <h1 className="greet-msg">
          Hey <strong>Salim</strong>
        </h1>
        <p className="greet-desc">What do you feel like doing today ?</p>
      ...
      <style jsx>{`
        ...
        .products-landing-page .greet-msg {
          font-size: 18px;
          font-weight: 500;
          margin-bottom: 18px;
        }
        .products-landing-page .greet-desc {
          font-size: 22px;
          margin-bottom: 36px;
        }
        .products-lists {
